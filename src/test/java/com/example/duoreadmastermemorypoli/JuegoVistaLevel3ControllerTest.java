...
/**
 * Clase de prueba para el controlador del nivel 3 del juego (JuegoVistaLevel3Controller).
...
class JuegoVistaLevel3ControllerTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/duoreadmastermemorypoli/JuegoVistaLevel3.fxml"));
    ...
    /**
     * Prueba unitaria para el método start() del controlador del nivel 3.
    ...
    /**
     * Prueba unitaria para el método volverLobby() del controlador del nivel 3.
    ...
    /**
     * Prueba unitaria para el método reiniciarJuego() del controlador del nivel 3.
    ...
    /**
     * Prueba unitaria para el método irASiguienteNivel() del controlador del nivel 3.
